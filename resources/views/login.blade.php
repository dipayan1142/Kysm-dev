  ...
  <main id="content" role="main" class="main">
    ...
    <div class="container py-5 py-sm-7">
      <a class="d-flex justify-content-center mb-5" href="{{ url('/') }}">
        <img class="zi-2" src="{{url('assets/svg/logos/logo-new.png')}}" alt="Image Description" style="width: 8rem;">
      </a>
      ...
      <div class="mx-auto" style="max-width: 30rem;">
        ...
        <div class="card card-lg mb-5">
          <div class="card-body">
            <!-- Form -->
            <form class="js-validate needs-validation" novalidate action="{{ url('login') }}" method="post">
              {{ csrf_field() }}
              <!-- <div class="text-center">
                <div class="mb-5">
                  <h1 class="display-5">Sign in</h1>
                  <p>Don't have an account yet? <a class="link" href="{{url('/register')}}">Sign up here</a></p>
                </div>
              </div> -->
        ...
        <div class="position-relative text-center zi-1">
          <small class="text-cap text-body mb-4">FOR INTERNAL USE ONLY</small>
        </div>
        <!-- End Footer -->
      </div>
    </div>
