...
<main id="content" role="main" class="main">
    ...
    <div class="content container-fluid">
        <!-- Step Form -->
        <form class="js-step-form py-md-5" action="{{url('banner/create')}}" method="post"  enctype="multipart/form-data">
                        ...
                        <div id="addUserStepProfile" class="card card-lg active">
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    <div class="mb-5">
                                        <h1 class="display-5">Create new Banner</h1>
                                    </div>
                                </div>
                                <!-- Form -->
                                <div class="row mb-4">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-vertical">
                                            <input type="text" class="form-control" name="name" id="firstNameLabel" placeholder="Enter Title" aria-label="Enter Title" required>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Form -->
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="desc" id="descLabel" placeholder="Enter Description" aria-label="Enter Description" rows="3"></textarea>
                                    </div>
                                </div>
                                <!-- End Form -->
