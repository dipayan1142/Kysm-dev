...
<main id="content" role="main" class="main">
    ...
    <div class="content container-fluid">
        <!-- Step Form -->
        <form class="js-step-form py-md-5" action="{{url('banner/edit')}}" method="post"  enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    ...
                                    "allowTypes": [".png", ".jpeg", ".jpg"]
                                            ...
                                            <img id="avatarImg" class="avatar-img" src="{{url('uploads/banners')}}/{{ $banner->thumbal }}" alt="Image Description">
                                            </label>    
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-vertical">
                                            <input type="text" class="form-control" name="name" id="firstNameLabel" value="{{$banner->name}}" placeholder="Enter Title" aria-label="Enter Title" required>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Form -->
                                ...
                                <!-- Form -->
                                <div class="row mb-4">
                                    <label for="descLabel" class="col-sm-3 col-form-label form-label">Description <span class="form-label-secondary">(Optional)</span></label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="desc" id="descLabel" placeholder="Enter Description" aria-label="Enter Description" rows="3">{{$banner->desc}}</textarea>
                                    </div>
                                </div>
                                <!-- End Form -->
