...
class ContactusController extends Controller
{
    public function __construct($parameters = array())
    {
        ...
        $this->_module      = 'ContactUs';
        $this->_routePrefix = 'contact';
        $this->_model       = new ContactUs();
    }
    ...
    public function index(Request $request)
    {
        ...
        $this->initIndex();
        $this->_data['permisssionState']    = \App\Models\Permission::checkModulePermissions(['index'], 'ContactusController');
